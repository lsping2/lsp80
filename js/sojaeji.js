...
sojaeji.prototype = {
	...
	update_sido : function() {
		...
		update_all : function (sido1, gugun1, dong1){
        this.sido.value = sido1;
        this.update_gugun();
        this.gugun.value = gugun1;
        this.update_dong();
        this.dong.value = dong1;
    },


 '시도' : ['서울','부산','대구','인천','광주','대전','세종','울산','강원','경기','경남','경북','전남','전북','제주','충남','충북'],
 '세종' : ['세종특별자치시'],
