...
<script language="JavaScript" src="/js/coin.js"></script>
...
<thead>
    <tr >
        ...
        <th style="width:150px;text-align: center">코인명  </th>
        <th style="width:150px;text-align: right">세계평균(원) </th>
        <th style="width:100px;text-align: right">세계평균(＄)  </th>
        <th style="text-align: center">가격(BTC)  </th>
