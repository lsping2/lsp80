<!-- <HTML>
<HEAD>
<TITLE> 주민등록번호 조회 </TITLE>
<script language="JavaScript" src="document03.js"></script><br>
<h3></h3>
<SCRIPT LANGUAGE="JavaScript">

function agree()
{
firstNum = new Array(6);
lastNum = new Array(7);
firstNum = document.gaip2.number1.value.split("");
lastNum = document.gaip2.number2.value.split("");
num=(firstNum[0]*2)+(firstNum[1]*3)+(firstNum[2]*4)+(firstNum[3]*5)+(firstNum[4]*6)+(firstNum[5]*7)+
(lastNum[0]*8)+(lastNum[1]*9)+(lastNum[2]*2)+(lastNum[3]*3)+(lastNum[4]*4)+(lastNum[5]*5)
num=11-(num%11);
check = num%10;

if(check!=lastNum[6])
{
alert(document.gaip.name.value + "님의 주민등록번호가 일치하지 않습니다.");
}
else
{
...
<FONT SIZE="3" FACE="굴림"><CENTER>주민등록번호 확인</CENTER>

<TABLE ALIGN="CENTER">
<TR>
<FORM NAME="gaip">
<TD><BASEFONT SIZE="2">성명</TD>
<TD><INPUT TYPE="text" SIZE="8" NAME="name"></TD>
</FORM>
</TR>
<TR>
<FORM NAME="gaip2">
<TD><BASEFONT SIZE="2">주민등록번호</TD>
<TD><INPUT TYPE="text" SIZE="7" NAME="number1"onKeyPress="NumObj(this);" style="ime-mode:disabled;">&nbsp;-&nbsp;<INPUT TYPE="text" SIZE="8" NAME="number2" onKeyPress="NumObj(this);" style="ime-mode:disabled;"></TD>
</FORM>
</TR>
<TR>
<TD></TD>
<TD><INPUT TYPE="submit" NAME="submit_regi" VALUE="확인" ONCLICK="agree()"></TD>
</TR>
</TABLE>
</BODY>
</HTML>
