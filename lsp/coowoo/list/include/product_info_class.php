...
class ProductInfo extends MYSQL
{
	...
	public $folder_sell_price;
	public $folder_discount_sell_price;
	public $folder_mileage;

	// 제품 정보 변수
	public $product_image_order_no;
	public $product_order_no;
	public $product_sell_price;
	public $product_discount_sell_price;
	public $product_mileage;
	public $product_image_name;
	public $product_data_folder_name;
	public $product_sub_folder_name;

	public $product_discount_rate;
	public $product_discount_price;
	public $product_mileage_rate;
	public $product_mileage_price;

	public $product_cd_sell_status;
	public $product_vcd_sell_status;
	public $product_single_sell_status;
	...
	public $cd_sell_price;
	public $vcd_sell_price;
	public $cd_sell_status;
	public $vcd_sell_status;
	public $vat_price;
