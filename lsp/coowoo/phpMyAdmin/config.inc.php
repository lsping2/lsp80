 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://www.coowoo.com/sql';
...
$i++;
$cfg['Servers'][$i]['host']          = '61.109.245.238'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['controlpass']   = 'woo9210';          // access to the "mysql/user"
                                                    // and "mysql/db" tables).
...
$cfg['Servers'][$i]['password']      = 'woo9210';          // MySQL password (only needed
...
$i++;
$cfg['Servers'][$i]['host']            = 'funnjoy.net';
$cfg['Servers'][$i]['port']            = '';
$cfg['Servers'][$i]['socket']          = '';
$cfg['Servers'][$i]['connect_type']    = 'tcp';
$cfg['Servers'][$i]['compress']        = FALSE;
$cfg['Servers'][$i]['controluser']     = 'funnjoy';
$cfg['Servers'][$i]['controlpass']     = 'vmfkdla';
$cfg['Servers'][$i]['auth_type']       = 'http';
$cfg['Servers'][$i]['user']            = '';
$cfg['Servers'][$i]['password']        = '';
$cfg['Servers'][$i]['only_db']         = 'funnjoy';
...
$i++;
$cfg['Servers'][$i]['host']            = '61.109.245.237';
$cfg['Servers'][$i]['port']            = '';
$cfg['Servers'][$i]['socket']          = '';
$cfg['Servers'][$i]['connect_type']    = 'tcp';
$cfg['Servers'][$i]['compress']        = FALSE;
...
$cfg['Servers'][$i]['password']        = 'woo9210';
