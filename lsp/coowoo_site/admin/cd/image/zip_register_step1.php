...
<font style="font-size:9pt">- ZIP파일을 등록할 시디의 주문번호를 입력해 주세요.</font><br><br>
<form name=Form action="zip_register_step2.php" method=get onSubmit="return checkForm( this )">
