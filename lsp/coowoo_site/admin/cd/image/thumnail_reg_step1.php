<?
// data_folder 테이블에서 data_folder_no 의 정보를 가져와 thumnail_reg_step2.php 으로 넘김
...
<form name=Form method=get action=thumnail_reg_step2.php onSubmit="return checkForm( this )">
