<?
// CD→싱글 등록 (자동)   cd2single_step2.php 로 각각의 테이블에 뽑아온 값들을 넘김
...
<b><font size=3>* CD → 싱글 등록</font></b><br><br>
<form name=Form method=get action=cd2single_step2.php onSubmit="return checkForm( this )">
...
<tr>
	...
	<tr>
		...
		<td>
<?
// 라이센스 테이블의 총 레코드 수만큼 license_name 을 뽑아옴
...
<? endif ?>
		...
		<td>
<?
//data_folder 테이블( 스토리지 ) 에서 전체 레코수만큼 data_folder_name 를 뽑아옴
...
<? endif ?>
		...
		<td>
<?
// single_pricelist_name (가격표) 테이블 에서 토탈 레코드수만큼 뽑아와 pricelist_name 
$query = "
			SELECT	pricelist_no ,
					pricelist_name
