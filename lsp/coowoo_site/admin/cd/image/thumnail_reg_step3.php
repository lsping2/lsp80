...
<body>
<b><font size=3>* CD 섬네일 재등록 - 확인</font></b><br><br>
...
<tr>
	...
	<? if( $file_count ) : ?>
	<a href="thumnail_reg_step4.php?data_folder_no=<?=$data_folder_no?>&cd_folder=<?=$cd_folder?>&thumnail_folder=<?=$thumnail_folder?>" onFocus='this.blur()'>[   등록시작   ]</a>
	<? endif ?>
