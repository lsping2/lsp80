...
$lat = 37.488; // 초기 및 리셋 중심좌표
$lng = 126.9696; // 초기 및 리셋 중심좌표
...
map.addControl(zoomControl, daum.maps.ControlPosition.RIGHT);
   ...
   //    '  <a href="./bbs/board.php?bo_table=list&wr_id=<?=$row[wr_id]?>" class="d_sLightBox2 iframe">' +
    var content = '<div class="customoverlay">' +
    '<a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>&wr_id=<?php echo $row['wr_id'] ?>">' +
    '    <span class="title"><?php echo $row['wr_subject'] ?></span>' +
    '</a>' +
    '</div>';
