...
if( !$is_admin){
	if( $view['wr_1'] != $member['mb_id']) alert('잘못된 경로입니다.');
}
...
$(function(){ // 날짜 입력
		$("#sub10, #sub19, #sub20, #sub21, #sub22, #sub23, #sub38").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true }); 
	});
