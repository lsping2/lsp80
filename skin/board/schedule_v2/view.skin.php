...
<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td><?php echo number_format($write['wr_3']) ?></td>
        </tr>
		<tr>
            <th scope="row"><label for="wr_4"><font color="blue">당일손익</font><strong class="sound_only">필수</strong></label></th>
            <td><?php echo number_format($write['wr_4']) ?></td>
        </tr>
		<tr>
            <th scope="row"><label for="wr_5">보유잔고<strong class="sound_only">필수</strong></label></th>
            <td><?php echo number_format($write['wr_5']) ?></td>
        </tr>
		<tr>
            <th scope="row"><label for="wr_6">평가손익<strong class="sound_only">필수</strong></label></th>
            <td><?php echo number_format($write['wr_6']) ?></td>
        </tr>
		</tbody>
	</table>
