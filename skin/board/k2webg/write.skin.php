...
?><?=$write[wr_8]?>, <?=$write[wr_9]?>
<div id="map" style="width:100%;height:450px;"></div>

<div id="clickLatlng"></div>
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fc7c7d727754bef9ca90750a306393fe&libraries=services"></script>
<script>
/*
...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			<th>위도 /경도</th>
			<td><input type="text" name="wr_8" value="<?php echo $write['wr_8'] ?>" id="wr_8"  class="frm_input full_input">  <input type="text" name="wr_9" value="<?php echo $write['wr_9'] ?>" id="wr_9"  class="frm_input full_input">
    </div></td>
	</tr>
