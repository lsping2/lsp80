...
function page_list( $url, $httpvar="", $anchor = "" )
{
	...
	if ( $page - 1 > 0 )
	{
		...
		echo "<a href='{$url}?{$httpvar}page=" . ( $page - 1 ) . "{$anchor}' onFocus='this.blur()'><img  src='/img/btn_before.jpg' border='0' align='absmiddle'></a>&nbsp;";
	...
	if ( $page < $total_page )
	{
		echo "&nbsp;&nbsp;<a href='{$url}?{$httpvar}page=" . ( $page + 1 ) . "{$anchor}' onFocus='this.blur()'><font size='1' color=#AAAAAA><img  src='/img/btn_after.jpg' border='0' align='absmiddle'></font></a>";
	} // end of if
