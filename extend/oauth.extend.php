...
// 네이버로그인 API 정보
define('G5_NAVER_OAUTH_CLIENT_ID',  'st8Hsf10c_OAXmHMXUMh');
define('G5_NAVER_OAUTH_SECRET_KEY', 'Vy2RPoxSou');

// 카카오로그인 API 정보
define('G5_KAKAO_OAUTH_REST_API_KEY', '6e2fe9224487a7e8818962f7c1020c53');

// 페이스북로그인 API 정보
define('G5_FACEBOOK_CLIENT_ID',  '806628996049819');
define('G5_FACEBOOK_SECRET_KEY', '27f7013c849ab4e53df59fa62cc5c76a');

// 구글+ 로그인 API 정보
define('G5_GOOGLE_CLIENT_ID',  '89024960002-t6g9ivdefn5perp21k0v2bijk7n7eq2o.apps.googleusercontent.com');
define('G5_GOOGLE_SECRET_KEY', 'rhu8jendGdpTTpxBinEFdzI3');
